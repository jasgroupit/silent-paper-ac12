...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/silent-paper-ac12)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/silent-paper-ac12
```

A live public deployment of this template is available at [https://silent-paper-ac12.templates.workers.dev](https://silent-paper-ac12.templates.workers.dev)
